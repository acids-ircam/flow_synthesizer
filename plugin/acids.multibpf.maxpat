...
,
		"rect" : [ 1623.0, -1001.0, 638.0, 937.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 234.25, 133.076904, 31.0, 22.0 ],
					"style" : "",
					"text" : "+ 3."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.25, 55.0, 97.0, 22.0 ],
					"style" : "",
					"text" : "r #0_num_funcs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 944.0, 99.0, 22.0 ],
					"style" : "",
					"text" : "s #0_num_funcs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 955.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "pak 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 97.0, 885.0, 25.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 167.425537, 123.5, 25.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"panelcolor" : [ 0.32549, 0.345098, 0.372549, 1.0 ],
					"parameter_enable" : 1,
					"patching_rect" : [ 51.0, 885.0, 25.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 141.425537, 123.5, 25.0, 36.0 ],
					"prototypename" : "wet/dry",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.0, 993.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.0, 753.5, 110.0, 22.0 ],
					"style" : "",
					"text" : "gridcolor 1. 1. 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -34.666687, 501.0, 117.0, 22.0 ],
					"style" : "",
					"text" : "gridcolor 1. 1. 1. 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 946.0, 430.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -49.666687, 714.5, 292.0, 52.0 ],
					"style" : "",
					"text" : "definerange 0. 1., definethickness 0., definepoint none, defineline lines, definenumber none, gridcolor 1. 1. 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 201.5, 138.5, 153.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 94.833313, 90.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "uzi 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 94.833313, 182.153809, 35.0, 23.0 ],
					"style" : "",
					"text" : "/ 11."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 900.633362, 378.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numpoints" : 5,
					"outlettype" : [ "" ],
					"patching_rect" : [ 394.5, 885.0, 413.0, 115.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 2.0, 361.0, 136.5 ],
					"subplots" : [ 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 4.0, 361.0, 136.5 ],
					"subplots" : [ 						{
							"color" : [ 0.88, 0.32, 0.32, 1.0 ],
							"thickness" : 2.0,
							"point_style" : "none",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 711.5, 343.0, 120.0, 120.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 2.0, 361.0, 163.0 ],
					"proportion" : 0.39,
					"rounded" : 16,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 215.405151, 137.5, 134.454361, 18.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 243.75, 83.0, 125.333313, 83.0 ],
					"order" : 1,
					"source" : [ "obj-77", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 243.75, 178.115357, 120.333313, 178.115357 ],
					"source" : [ "obj-87", 0 ]
				}
