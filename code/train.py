...
parser.add_argument('--regressor',      type=str,   default='mlp',          help='')
parser.add_argument('--reg_layers',     type=int,   default=3,              help='')
parser.add_argument('--reg_hiddens',    type=int,   default=256,            help='')
parser.add_argument('--reg_flow',       type=str,   default='maf',          help='')
parser.add_argument('--reg_factor',     type=float, default=1e3,            help='')
...
parser.add_argument('--dis_layers',     type=int,   default=4,              help='')
parser.add_argument('--disentangling',  type=str,   default='density',      help='')
parser.add_argument('--start_disentangle',type=int, default=100,            help='')
parser.add_argument('--warm_disentangle',type=int,  default=25,             help='')
